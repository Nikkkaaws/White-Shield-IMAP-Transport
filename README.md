...
EN:
More information will be released later; you can follow the ongoing process, discuss it, and suggest new solutions on Telegram: https://t.me/wsitproject

RU:
Больше информации будет опубликовано позже, весь текущий процесс можете смотреть/обсуждать/предлагать новые решения в телеграм: https://t.me/wsitproject
